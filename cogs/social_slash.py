...
class slash(commands.Cog, name="Slash"):
    ...
    async def slash_slap(self, ctx, member, *, reason=None):
    ...
    async def slash_snuggle(self, ctx, member, *, reason=None):
    ...
    async def slash_hug(self, ctx, member, *, reason=None):
    ...
    async def slash_bonk(self, ctx, member, *, reason=None):
    ...
    async def slash_boop(self, ctx, member, *, reason=None):
    ...
    async def slash_smooch(self, ctx, member, *, reason=None):
    ...
    async def slash_lick(self, ctx, member, *, reason=None):
    ...
    async def slash_bellyrub(self, ctx, member, *, reason=None):
    ...
    async def slash_nuzzle(self, ctx, member, *, reason=None):
    ...
    async def slash_cuddle(self, ctx, member, *, reason=None):
    ...
    async def slash_feed(self, ctx, member, *, reason=None):
    ...
    async def slash_glomp(self, ctx, member, *, reason=None):
    ...
    async def slash_highfive(self, ctx, member, *, reason=None):
    ...
    async def slash_rawr(self, ctx, member, *, reason=None):
    ...
    async def slash_awoo(self, ctx, member, *, reason=None):
    ...
    async def slash_pat(self, ctx, member, *, reason=None):
    ...
    async def slash_cookie(self, ctx, member, *, reason=None):
    ...
    async def slash_blush(self, ctx, member=None):
    ...
    async def slash_happy(self, ctx, member=None):
    ...
    async def slash_wag(self, ctx, member=None):
    ...
    async def slash_quack(self, ctx, member=None):
